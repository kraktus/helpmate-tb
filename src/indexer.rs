...
pub fn index(b: &dyn Setup) -> u64 {
    ...
    for role in [Role::Pawn, Role::Knight, Role::Bishop, Role::Rook, Role::Queen] { // https://docs.rs/shakmaty/0.20.2/src/shakmaty/types.rs.html#43-50
